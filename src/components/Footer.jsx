...
const Footer = () => {
  return (
    // <div className="">
    //   <footer className="footer footer-center text-gray-800 rounded p-10">
    ...
    //         <a target="_blank" className='text-[#52b788] bg-gray-800' href="https://facebook.com/salehiin"><FaSquareFacebook /></a>
    //         <a target="_blank" className='text-[#52b788] bg-gray-800' href="https://www.linkedin.com/in/shoebsalehinkhan/"><FaLinkedin /></a>
    //         <a target="_blank" className='text-[#52b788] bg-gray-800' href="https://github.com/salehiin"><FaSquareGithub /></a>
    //       </div>
    //     </nav>
    //     <aside>
    //       <p>
    //         Copyright © {new Date().getFullYear()} - All right reserved by Shoeb Salehin Khan
    //       </p>
    //     </aside>
    //   </footer>
    // </div>
    <footer className="footer text-gray-800 items-center p-4">
